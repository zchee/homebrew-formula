class GwsCliHead < Formula
  desc "Google Workspace CLI"
  homepage "https://github.com/googleworkspace/cli"
  license "Apache-2.0"
  head "https://github.com/googleworkspace/cli.git", branch: "main"
  ...
  def install
    ...
    system "rustup", "run", "nightly", "cargo", "install", "--verbose", "--all-features", *std_cargo_args(path: "crates/google-workspace-cli")
  end
end
