class CodexHead < Formula
  ...
  def install
    ...
    system "codesign", "--force", "--options", "runtime", "--timestamp", "--entitlements", ".github/actions/macos-code-sign/codex.entitlements.plist", "--sign", "-", bin/"codex-responses-api-proxy"
